...
PR_TOOLBOX_DIR = dirname(abspath(__file__))
...
class PyClassificationToolbox(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        try:
            self.featurespace.loadDefaultFeatureSpace(join(PR_TOOLBOX_DIR, '..', 'featurespace.pyct'))
        except Exception:
            print("could not open default feature space")

    def initUI(self):
        os.chdir(PR_TOOLBOX_DIR)
        ...
        exitAction = QtWidgets.QAction(QtGui.QIcon(join(PR_TOOLBOX_DIR, 'img/exit.png')), 'Exit', self)
        exitAction.setShortcut('Ctrl+Q')
        exitAction.triggered.connect(QtWidgets.qApp.quit)

        coordinateSystemAction = QtWidgets.QAction(QtGui.QIcon(
            join(PR_TOOLBOX_DIR, 'img/coord.png')), 'Move coordinate system', self)
        coordinateSystemAction.triggered.connect(self.onMoveCoordinateSystem)

        gaussCreateAction = QtWidgets.QAction(QtGui.QIcon(
            join(PR_TOOLBOX_DIR, 'img/create_gauss.png')), 'Create Gaussians', self)
        gaussCreateAction.triggered.connect(self.onCreateGaussians)

        gaussModifyAction = QtWidgets.QAction(QtGui.QIcon(
            join(PR_TOOLBOX_DIR, 'img/modify_gauss.png')), 'Modify Gaussians', self)
        ...
        self.moveCoordinateSystemButton.setIcon(
            QtGui.QIcon(resource_path(join(PR_TOOLBOX_DIR, 'img/coord.png'))))
        ...
        self.createGaussButton.setIcon(
            QtGui.QIcon(resource_path(join(PR_TOOLBOX_DIR, 'img/create_gauss.png'))))
        ...
        self.modifyGaussButton.setIcon(
            QtGui.QIcon(resource_path(join(PR_TOOLBOX_DIR, 'img/modify_gauss.png'))))
        ...
        self.createSamplesButton.setIcon(
            QtGui.QIcon(resource_path(join(PR_TOOLBOX_DIR, './img/samples.png'))))
        ...
        self.toolbar = QtWidgets.QToolBar("Create Sample Toolbar", self)
        ...
        QtWidgets.QShortcut(QtGui.QKeySequence("Ctrl+R"), self, self.redo)
    ...
    def closeEvent(self, event):
        try:
            self.featurespace.saveDefaultFeatureSpace(join(PR_TOOLBOX_DIR, '..', 'featurespace.pyct'))
        except Exception as e:
            print(f"could not save default feature space: {e}")
