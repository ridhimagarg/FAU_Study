...
class GaussProperties(QtWidgets.QDialog):
    def __init__(self,
        ...
        self.isIncludedCheckBox = QtWidgets.QCheckBox(
        ...
        classGrid.addWidget(self.isIncludedCheckBox, 2, 0, 1, 2,
                            QtCore.Qt.AlignLeft)
        ...
        self.setProperties(classId, numSamples, mean1, mean2, cov11, cov22,
                           cov12, isIncluded)
    ...
    def getProperties(self):
        ...
        return (classId, numSamples, mean1, mean2, cov11, cov22, cov12,
                isIncluded)
