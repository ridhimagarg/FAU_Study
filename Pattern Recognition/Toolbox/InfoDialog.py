...
class InfoDialog(QtWidgets.QDialog):
    def __init__(self, parent):
        ...
        s = "{0:04d},  {1}".format(
            version.__build__, version.__versiondate__.strftime('%B %d, %Y'))
        ...
        try:
            import cvxopt
            grid2.addWidget(QtWidgets.QLabel(cvxopt.__version__), i, 1)
        except Exception:
            grid2.addWidget(QtWidgets.QLabel("Cxopt missing"), i, 1)
        i += 1
        ...
        i += 1
        grid2.addWidget(QtWidgets.QLabel('PyQt5'), i, 0)
        ...
        frame.setSizeConstraint(QtWidgets.QLayout.SetFixedSize)
