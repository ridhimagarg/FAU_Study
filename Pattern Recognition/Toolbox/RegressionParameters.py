...
class RegressionParameters(QtWidgets.QDialog):
    def __init__(self, parent):
        ...
        linRegLossFunctionParameterLabel = QtWidgets.QLabel(
        ...
        self.linRegLossFunctionCombobox.currentIndexChanged.connect(
            self.onLinRegLossFunctionChanged)
        ...
        self.SVRKernelCombobox.currentIndexChanged.connect(
            self.onSVRKernelChanged)
        ...
        self.SVREpsilonEdit.setToolTip(
            'Specifies the epsilon-tube within which no penalty is associated in the training loss function with points predicted within a distance epsilon from the actual value.'
        )
        ...
        RegressionTreeMinSamplesSplitLabel = QtWidgets.QLabel(
            'Minimum samples required to split internal node')
        RegressionTreeMinSamplesLeafLabel = QtWidgets.QLabel(
            'Minimum samples required at leaf node')
        RegressionTreeMinWeightedFractionLeafLabel = QtWidgets.QLabel(
            'Minimum weighted fraction at leaf node')
        RegressionTreeMaxLeafNodesLabel = QtWidgets.QLabel(
            'Maximum leaf nodes')
        RegressionTreeNumTrialsPerSplitLabel = QtWidgets.QLabel(
            'Number of trials to split a node')
        self.RegressionTreeAlgorithmCombobox = QtWidgets.QComboBox()
        self.RegressionTreeAlgorithmCombobox.addItem(
            'RegressionTreeRegressor (scikit-learn)')
        self.RegressionTreeAlgorithmCombobox.addItem('Regression Tree')
        self.RegressionTreeAlgorithmCombobox.currentIndexChanged.connect(
            self.onRegressionTreeAlgorithmChanged)
        self.RegressionTreeCriterionCombobox = QtWidgets.QComboBox()
        self.RegressionTreeCriterionCombobox.addItem(
        ...
        self.RegressionTreeMaxDepthCombobox.addItems(
            [str(x) for x in range(1, 10)])
        self.RegressionTreeMaxDepthCombobox.setEditable(True)
        self.RegressionTreeMaxDepthCombobox.setInsertPolicy(
        ...
        self.RegressionTreeMinWeightedFractionLeafEdit = QtWidgets.QLineEdit(
            '0.')
        self.RegressionTreeMaxLeafNodesCombobox = QtWidgets.QComboBox()
        self.RegressionTreeMaxLeafNodesCombobox.addItems(
            ['None', '10', '20', '30', '40', '50'])
        self.RegressionTreeMaxLeafNodesCombobox.setEditable(True)
        self.RegressionTreeMaxLeafNodesCombobox.setInsertPolicy(
            QtWidgets.QComboBox.InsertAlphabetically)
        self.RegressionTreeMaxLeafNodesCombobox.currentIndexChanged.connect(
            self.onRegressionTreeMaxLeafNodesChanged)
        ...
        RegressionTreeGrid.addWidget(self.RegressionTreeAlgorithmCombobox, 0,
                                     1)
        RegressionTreeGrid.addWidget(RegressionTreeCriterionLabel, 1, 0)
        RegressionTreeGrid.addWidget(self.RegressionTreeCriterionCombobox, 1,
                                     1)
        ...
        RegressionTreeGrid.addWidget(self.RegressionTreeMinSamplesSplitEdit, 4,
                                     1)
        RegressionTreeGrid.addWidget(RegressionTreeMinSamplesLeafLabel, 5, 0)
        RegressionTreeGrid.addWidget(self.RegressionTreeMinSamplesLeafEdit, 5,
                                     1)
        RegressionTreeGrid.addWidget(
            RegressionTreeMinWeightedFractionLeafLabel, 6, 0)
        RegressionTreeGrid.addWidget(
            self.RegressionTreeMinWeightedFractionLeafEdit, 6, 1)
        RegressionTreeGrid.addWidget(RegressionTreeMaxLeafNodesLabel, 7, 0)
        RegressionTreeGrid.addWidget(self.RegressionTreeMaxLeafNodesCombobox,
                                     7, 1)
        RegressionTreeGrid.addWidget(RegressionTreeNumTrialsPerSplitLabel, 8,
                                     0)
        RegressionTreeGrid.addWidget(self.RegressionTreeNumTrialsPerSplitEdit,
                                     8, 1)
        ...
        RegressionForestMinSamplesSplitLabel = QtWidgets.QLabel(
            'Minimum samples required to split internal node')
        RegressionForestMinSamplesLeafLabel = QtWidgets.QLabel(
            'Minimum samples required at leaf node')
        RegressionForestMinWeightedFractionLeafLabel = QtWidgets.QLabel(
            'Minimum weighted fraction at leaf node')
        RegressionForestMaxLeafNodesLabel = QtWidgets.QLabel(
            'Maximum leaf nodes')
        RegressionForestNumTrialsPerSplitLabel = QtWidgets.QLabel(
            'Number of trials to split a node')
        self.RegressionForestAlgorithmCombobox = QtWidgets.QComboBox()
        self.RegressionForestAlgorithmCombobox.addItem(
            'RegressionForestRegressor (scikit-learn)')
        self.RegressionForestAlgorithmCombobox.addItem('Regression Forest')
        self.RegressionForestAlgorithmCombobox.currentIndexChanged.connect(
            self.onRegressionForestAlgorithmChanged)
        self.RegressionForestNumTreesEdit = QtWidgets.QLineEdit('10')
        self.RegressionForestCriterionCombobox = QtWidgets.QComboBox()
        self.RegressionForestCriterionCombobox.addItem(
            'mean squared error (mse)')
        ...
        self.RegressionForestMaxDepthCombobox.addItems(
            [str(x) for x in range(1, 10)])
        self.RegressionForestMaxDepthCombobox.setEditable(True)
        self.RegressionForestMaxDepthCombobox.setInsertPolicy(
            QtWidgets.QComboBox.InsertAlphabetically)
        ...
        self.RegressionForestMinWeightedFractionLeafEdit = QtWidgets.QLineEdit(
            '0.')
        self.RegressionForestMaxLeafNodesCombobox = QtWidgets.QComboBox()
        self.RegressionForestMaxLeafNodesCombobox.addItems(
            ['None', '10', '20', '30', '40', '50'])
        self.RegressionForestMaxLeafNodesCombobox.setEditable(True)
        self.RegressionForestMaxLeafNodesCombobox.setInsertPolicy(
            QtWidgets.QComboBox.InsertAlphabetically)
        self.RegressionForestMaxLeafNodesCombobox.currentIndexChanged.connect(
            self.onRegressionForestMaxLeafNodesChanged)
        ...
        RegressionForestGrid.addWidget(self.RegressionForestAlgorithmCombobox,
                                       0, 1)
        ...
        RegressionForestGrid.addWidget(self.RegressionForestCriterionCombobox,
                                       2, 1)
        RegressionForestGrid.addWidget(RegressionForestMaxDepthLabel, 3, 0)
        RegressionForestGrid.addWidget(self.RegressionForestMaxDepthCombobox,
                                       3, 1)
        RegressionForestGrid.addWidget(RegressionForestMinSamplesSplitLabel, 4,
                                       0)
        RegressionForestGrid.addWidget(
            self.RegressionForestMinSamplesSplitEdit, 4, 1)
        RegressionForestGrid.addWidget(RegressionForestMinSamplesLeafLabel, 5,
                                       0)
        RegressionForestGrid.addWidget(self.RegressionForestMinSamplesLeafEdit,
                                       5, 1)
        RegressionForestGrid.addWidget(
            RegressionForestMinWeightedFractionLeafLabel, 6, 0)
        RegressionForestGrid.addWidget(
            self.RegressionForestMinWeightedFractionLeafEdit, 6, 1)
        RegressionForestGrid.addWidget(RegressionForestMaxLeafNodesLabel, 7, 0)
        RegressionForestGrid.addWidget(
            self.RegressionForestMaxLeafNodesCombobox, 7, 1)
        RegressionForestGrid.addWidget(RegressionForestNumTrialsPerSplitLabel,
                                       8, 0)
        RegressionForestGrid.addWidget(
            self.RegressionForestNumTrialsPerSplitEdit, 8, 1)
        ...
        self.buttons.button(
            QtWidgets.QDialogButtonBox.Cancel).setText("Cancel")
        self.buttons.button(
            QtWidgets.QDialogButtonBox.Ok).setText("Compute regression")
    ...
    def checkParameters(self, tab):
        if tab == 0:  # Linear Regression parameters
            if not self.testParameter(
                    self.getLinRegLossFunctionParam,
                    'The parameter of the loss function has to be a floating point number!'
            ):
                return False
            ...
            if a <= 0:
                self.errorMsg(
                    'The parameter of the loss function has to be positive!')
                return False

        elif tab == 1:  # SVR parameters
            if not self.testParameter(
                    self.getSVRC,
                    'The penalty parameter C has to be a floating point number!'
            ):
                return False

            if not self.testParameter(
                    self.getSVREpsilon,
                    'The Epsilon parameter has to be a floating point number!'
            ):
                return False

            if not self.testParameter(
                    self.getSVRGamma,
                    'The kernel parameter Gamma has to be a floating point number!'
            ):
                return False

            if not self.testParameter(
                    self.getSVRCoef0,
                    'The independent term in the kernel function Coef0 has to be a floating point number!'
            ):
                return False

            if not self.testParameter(
                    self.getSVRDegree,
                    'The degree of the polynomial kernel function has to be an integer number!'
            ):
                return False
            ...
            if degree < 1:
                self.errorMsg(
                    'The degree of the polynomial kernel has to be at least 1!'
                )
                return False
            ...
            if not self.testParameter(
                    self.getRegressionTreeMaxDepth,
                    'The maximum depth of the tree has to be None or an integer number!'
            ):
                return False

            if not self.testParameter(
                    self.getRegressionTreeMaxLeafNodes,
                    'The maximum number of leaf nodes has to be None or an integer number!'
            ):
                return False

            if not self.testParameter(
                    self.getRegressionTreeMinSamplesSplit,
                    'The minimum number of samples required to split an internal node has to be an integer number!'
            ):
                return False

            if not self.testParameter(
                    self.getRegressionTreeMinSamplesLeaf,
                    'The minimum number of samples required to be at a leaf node has to be an integer number!'
            ):
                return False

            if not self.testParameter(
                    self.getRegressionTreeMinWeightedFractionLeaf,
                    'The minimum weighted fraction of the input samples required to be at a leaf node has to be a real number!'
            ):
                return False

            if not self.testParameter(
                    self.getRegressionTreeNumTrialsPerSplit,
                    'The number of trials to split a node has to be an integer number!'
            ):
                return False
            ...
            if not (depth == None) and (depth < 1):
                self.errorMsg(
                    'The maximum depth of the tree has to be at least 1!')
                return False

            leafNodes = self.getRegressionTreeMaxLeafNodes()
            if not (leafNodes == None) and (leafNodes < 2):
                self.errorMsg(
                    'The maximum number of leaf nodes has to be at least 2!')
                return False

            split = self.getRegressionTreeMinSamplesSplit()
            if split < 2:
                self.errorMsg(
                    'The minimum number of samples required to split an internal node has to be at least 2!'
                )
                return False
            ...
            if leaf < 1:
                self.errorMsg(
                    'The minimum number of samples required to be at a leaf node has to be at least 1!'
                )
                return False
            ...
            if (fraction < 0) or (fraction > 0.5):
                self.errorMsg(
                    'The minimum weighted fraction of the input samples required to be at a leaf node has to be between 0.0 and 0.5!'
                )
                return False
            ...
            if trials < 1:
                self.errorMsg(
                    'The number of trials to split a node has to be at least 1!'
                )
                return False

        elif tab == 3:  # Regression Forest parameters
            if not self.testParameter(
                    self.getRegressionForestNumTrees,
                    'The number of trees in the forest has to be an integer number!'
            ):
                return False

            if not self.testParameter(
                    self.getRegressionForestMaxDepth,
                    'The maximum depth of the tree has to be None or an integer number!'
            ):
                return False

            if not self.testParameter(
                    self.getRegressionForestMaxLeafNodes,
                    'The maximum number of leaf nodes has to be None or an integer number!'
            ):
                return False

            if not self.testParameter(
                    self.getRegressionForestMinSamplesSplit,
                    'The minimum number of samples required to split an internal node has to be an integer number!'
            ):
                return False

            if not self.testParameter(
                    self.getRegressionForestMinSamplesLeaf,
                    'The minimum number of samples required to be at a leaf node has to be an integer number!'
            ):
                return False

            if not self.testParameter(
                    self.getRegressionForestMinWeightedFractionLeaf,
                    'The minimum weighted fraction of the input samples required to be at a leaf node has to be a real number!'
            ):
                return False

            if not self.testParameter(
                    self.getRegressionForestNumTrialsPerSplit,
                    'The number of trials to split a node has to be an integer number!'
            ):
                return False
            ...
            if trees < 1:
                self.errorMsg(
                    'The number of trees in the forest has to be at least 1!')
                return False
    ...
    def getParameters(self):
        params = {}
        params[
            'LinReg_loss_function'] = self.linRegLossFunctionCombobox.currentIndex(
            )
        params[
            'LinReg_loss_function_param'] = self.linRegLossFunctionParameterEdit.text(
            )
        ...
        params[
            'regression_tree_algo'] = self.RegressionTreeAlgorithmCombobox.currentIndex(
            )
        params[
            'regression_tree_criterion'] = self.RegressionTreeCriterionCombobox.currentIndex(
            )
        params[
            'regression_tree_splitter'] = self.RegressionTreeSplitterCombobox.currentIndex(
            )
        params[
            'regression_tree_max_depth'] = self.RegressionTreeMaxDepthCombobox.currentIndex(
            )
        params[
            'regression_tree_min_samples_split'] = self.RegressionTreeMinSamplesSplitEdit.text(
            )
        params[
            'regression_tree_min_samples_leaf'] = self.RegressionTreeMinSamplesLeafEdit.text(
            )
        params[
            'regression_tree_min_weighted_fraction_leaf'] = self.RegressionTreeMinWeightedFractionLeafEdit.text(
            )
        params[
            'regression_tree_max_leaf_nodes'] = self.RegressionTreeMaxDepthCombobox.currentIndex(
            )
        params[
            'regression_tree_num_trials_per_split'] = self.RegressionTreeNumTrialsPerSplitEdit.text(
            )
        params[
            'regression_forest_algo'] = self.RegressionForestAlgorithmCombobox.currentIndex(
            )
        params[
            'regression_forest_numtrees'] = self.RegressionForestNumTreesEdit.text(
            )
        params[
            'regression_forest_criterion'] = self.RegressionForestCriterionCombobox.currentIndex(
            )
        params[
            'regression_forest_max_depth'] = self.RegressionForestMaxDepthCombobox.currentIndex(
            )
        params[
            'regression_forest_min_samples_split'] = self.RegressionForestMinSamplesSplitEdit.text(
            )
        params[
            'regression_forest_min_samples_leaf'] = self.RegressionForestMinSamplesLeafEdit.text(
            )
        params[
            'regression_forest_min_weighted_fraction_leaf'] = self.RegressionForestMinWeightedFractionLeafEdit.text(
            )
        params[
            'regression_forest_max_leaf_nodes'] = self.RegressionForestMaxDepthCombobox.currentIndex(
            )
        params[
            'regression_forest_num_trials_per_split'] = self.RegressionForestNumTrialsPerSplitEdit.text(
            )
        return params

    def restoreParameters(self):
        params = self.__parameters
        self.linRegLossFunctionCombobox.setCurrentIndex(
            params['LinReg_loss_function'])
        self.linRegLossFunctionParameterEdit.setText(
            params['LinReg_loss_function_param'])
        ...
        self.RegressionTreeAlgorithmCombobox.setCurrentIndex(
            params['regression_tree_algo'])
        self.RegressionTreeCriterionCombobox.setCurrentIndex(
            params['regression_tree_criterion'])
        self.RegressionTreeSplitterCombobox.setCurrentIndex(
            params['regression_tree_splitter'])
        self.RegressionTreeMaxDepthCombobox.setCurrentIndex(
            params['regression_tree_max_depth'])
        self.RegressionTreeMinSamplesSplitEdit.setText(
            params['regression_tree_min_samples_split'])
        self.RegressionTreeMinSamplesLeafEdit.setText(
            params['regression_tree_min_samples_leaf'])
        self.RegressionTreeMinWeightedFractionLeafEdit.setText(
            params['regression_tree_min_weighted_fraction_leaf'])
        self.RegressionTreeMaxDepthCombobox.setCurrentIndex(
            params['regression_tree_max_leaf_nodes'])
        self.RegressionTreeNumTrialsPerSplitEdit.setText(
            params['regression_tree_num_trials_per_split'])
        self.RegressionForestAlgorithmCombobox.setCurrentIndex(
            params['regression_forest_algo'])
        self.RegressionForestNumTreesEdit.setText(
            params['regression_forest_numtrees'])
        self.RegressionForestCriterionCombobox.setCurrentIndex(
            params['regression_forest_criterion'])
        self.RegressionForestMaxDepthCombobox.setCurrentIndex(
            params['regression_forest_max_depth'])
        self.RegressionForestMinSamplesSplitEdit.setText(
            params['regression_forest_min_samples_split'])
        self.RegressionForestMinSamplesLeafEdit.setText(
            params['regression_forest_min_samples_leaf'])
        self.RegressionForestMinWeightedFractionLeafEdit.setText(
            params['regression_forest_min_weighted_fraction_leaf'])
        self.RegressionForestMaxDepthCombobox.setCurrentIndex(
            params['regression_forest_max_leaf_nodes'])
        self.RegressionForestNumTrialsPerSplitEdit.setText(
            params['regression_forest_num_trials_per_split'])
    ...
    def onRegressionTreeAlgorithmChanged(self, idx):
        if idx == 0:  # RegressionTreeRegressor (scikit-learn)
            ...
            if self.RegressionTreeMaxDepthCombobox.currentText().lower(
            ) == 'none':
    ...
    def onRegressionForestAlgorithmChanged(self, idx):
        if idx == 0:  # RegressionForestRegressor (scikit-learn)
            ...
            self.RegressionForestMaxLeafNodesCombobox.setCurrentIndex(
                0)  # None
            self.RegressionForestMaxLeafNodesCombobox.setEnabled(False)
            if self.RegressionForestMaxDepthCombobox.currentText().lower(
            ) == 'none':
