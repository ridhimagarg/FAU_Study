...
class DimensionalityReductionParameters(QtWidgets.QDialog):
    def __init__(self, parent):
        ...
        # PCA tab
        self.PCARedDimCheckbox = QtWidgets.QCheckBox(
            'Reduce dimensionality to 1')
        self.PCARedDimCheckbox.stateChanged.connect(self.onPCARedDimChanged)
        self.PCASecondComponentCheckbox = QtWidgets.QCheckBox(
            'Select second component')
        self.PCABackprojectCheckbox = QtWidgets.QCheckBox(
            'Backproject into 2-D')
    ...
    def getParameters(self):
        ...
        params[
            'pca_secondcomponent'] = self.PCASecondComponentCheckbox.isChecked(
            )
    ...
    def restoreParameters(self):
        ...
        self.PCASecondComponentCheckbox.setChecked(
            params['pca_secondcomponent'])
